...
INSERT INTO `category` VALUES (2,'Refrescos','Ricos refrescos exportados desde las lejanias de estados unidos para ofrecer un producto unico y saludable.',1),(16,'Panes','Ricos Panes',1),(17,'Lacteos','Lacteos de prueba',2),(18,'Carnes','',1),(19,'Cafes','',1),(20,'Embutidos','',1),(21,'SDSD','DSDSD',NULL);
...
CREATE TABLE `client` (
  ...
  `SECOND_LAST_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `company_data` VALUES (1,'Cabotaje Supplier','COLONIA KENENDY, CASA 1, BLOQUE 20, CONTIGUO A','cabotajesupplier@gmail.com','08011999123456',88795632,'Tegucigalpa, Francisco Morazán','facebook.com','instagram.com',98785236,3);
...
INSERT INTO `inventory` VALUES ('BOL1123',6,'Bolsa de semita','Ricas semitas',0.00,16,1),('CAF123',4,'Cafe Oro','Rico café',0.00,19,1),('CHO123',6,'Chorizo suelto','Rico chorizo',0.00,20,1),('JA123',6,'Jarron de Soya','Dsdsd',0.00,16,1),('LECH123',1,'Leche sula','Nueva producto de leche',518.00,17,1),('MEN123',1,'Cafe','Saffd',6332.00,2,2),('MOR134',6,'Mortadela','Rica mortadela',0.00,20,1),('PEP123',5,'Pepsi','Rica pepsi',0.00,2,1),('TAJ123',6,'TAJADAS','Ricas tajadas',23.00,2,1);
...
INSERT INTO `inventory_detail` VALUES (6,'MEN123',15.00,10.00,10.00,13.00,0.15,'2022-07-22','2022-07-31',5276.00,'CAF123',NULL,3),(19,'MEN123',25.00,20.00,25.00,23.00,0.15,'2022-07-28','2022-08-06',19.00,'MEN123',NULL,4),(20,'MEN123',21.00,20.00,0.00,0.00,0.00,'2022-07-28','2022-07-30',997.00,'MEN124',NULL,3),(25,'LECH123',28.00,20.00,20.00,25.00,0.15,'2022-07-27','2022-08-06',0.00,'LOT1234',NULL,3),(26,'LECH123',28.30,24.71,0.00,0.00,0.00,'2022-08-01','2022-08-09',6.00,'cal123',NULL,3),(27,'LECH123',55.55,50.00,5.00,60.00,0.00,'2022-08-01','2022-08-25',26.00,'MEL123',NULL,4),(28,'LECH123',30.55,25.00,20.00,20.00,0.00,'2022-08-01','2022-08-06',486.00,'CHM123',NULL,3),(29,'LECH123',25.00,20.00,0.00,0.00,0.00,'2022-08-01','2022-08-16',0.00,'PRUEBA123',NULL,4),(30,'MEN123',25.00,20.00,0.00,0.00,0.00,'2022-08-21','2022-08-21',15.00,'PER123',NULL,3),(31,'MEN123',25.00,20.00,0.00,0.00,0.20,'2022-08-21','2022-08-22',25.00,'ALF123',NULL,3),(32,'TAJ123',25.00,20.00,0.00,0.00,0.15,'2022-08-21','2022-08-21',23.00,'TAJ134',NULL,3);
...
CREATE TABLE `login` (
  ...
  `USER_NEW` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `REQUIRED_QUESTIONS` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `login` VALUES (1,3,1,'luis@hotmail.com','$2b$10$OGwnCF4PJpokbQMTbIa.p.kVbHidr/r4PXYeVUgzt9.eMVfjiAB6y','2022-07-23 19:09:02','2022-12-09 20:38:32',0,'false','false'),(2,4,3,'mendel@hotmail.com','$2b$10$70vJ9T853lMWEkauBLMEae2W948p.TgYDoRi602kDckl6BzRePh6C','2022-07-24 16:11:39','2022-12-09 20:44:34',0,'false','false'),(3,5,3,'lisandro@hotmail.com','$2b$10$xkIau07/yIn4OskngwhddeT6gmoSzfvex.kmrAZ4TCKZMDx6pjjfK','2022-07-31 19:21:36','2022-08-30 19:30:41',0,'false','false'),(4,6,1,'eortezluna@gmail.com','$2b$10$OhSd09aUHUJ7l50bOhGHS.vzpSDXA2d9OXU7LV13uLMjuZQ70ZBRW','2022-07-31 19:38:53','2022-08-01 19:38:53',0,'false','false'),(5,7,1,'mave@hotmail.com','$2b$10$iPY7V/XobeWfrYOO4FaMxuPt4egQmyYyKQ/WKdpZ.4iu798D6gGb6','2022-08-02 21:07:47','2022-08-03 21:07:47',0,'false','false'),(6,8,1,'a@a.com','$2b$10$/V/HNu9wfulm.LfQygSaFec4gRpI2eWzKVsdcNpmb7uAmGmj/ba2m','2022-08-02 21:11:11','2022-08-03 21:11:11',0,'false','false'),(9,11,1,'alexa@hotmail.com','$2b$10$7vzf01Q1lJg0OkfyMUwLceBv4B7PP5jW/6TbQ3XkVt0VP4WuwJrBS','2022-08-21 05:14:44','2022-08-22 12:50:50',0,'false','false');
...
CREATE TABLE `role` (
  ...
  KEY `FK_ROLE_STATUS` (`COD_STATUS`),
  CONSTRAINT `FK_ROLE_STATUS` FOREIGN KEY (`COD_STATUS`) REFERENCES `status` (`COD_STATUS`) ON DELETE CASCADE
...
INSERT INTO `role` VALUES (1,'Administrador','Permisos totales.',1),(2,'Usuario','Solo lectura.',1),(3,'Cajero','Realizara la ventas en caja',1);
...
INSERT INTO `sale_detail` VALUES (1,3,NULL,23.80,10.00,0.00,280.00),(2,6,'LECH123',21.25,10.00,0.00,250.00),(3,7,'LECH123',21.25,10.00,0.00,250.00),(4,8,'LECH123',21.25,3.00,0.00,75.00),(5,8,'LECH123',60.00,20.00,0.00,1200.00),(6,14,'LECH123',23.80,2.00,0.00,56.00),(7,14,'LECH123',55.55,15.00,0.00,833.25),(8,15,'MEN123',21.00,1.00,0.00,21.00),(9,16,'LECH123',30.55,15.00,0.00,458.25),(10,16,'LECH123',25.00,25.00,0.00,625.00),(11,17,'LECH123',30.55,1.00,0.00,30.55),(12,18,'LECH123',30.55,1.00,0.00,30.55),(13,19,'LECH123',30.55,1.00,0.00,30.55),(14,20,'LECH123',30.55,1.00,0.00,30.55),(15,21,'LECH123',30.55,1.00,0.00,30.55),(16,22,'LECH123',30.55,1.00,0.00,30.55),(17,23,'LECH123',30.55,1.00,0.00,30.55),(18,24,'LECH123',30.55,1.00,0.00,30.55),(19,25,'LECH123',30.55,1.00,0.00,30.55),(20,26,'LECH123',30.55,1.00,0.00,30.55),(21,32,'LECH
,4.00,0.00,122.20),(130,133,'LECH123',30.55,1.00,0.00,30.55),(131,134,'LECH123',30.55,1.00,0.00,30.55),(132,135,'LECH123',30.55,1.00,0.00,30.55),(133,136,'LECH123',30.55,1.00,0.00,30.55),(134,137,'MEN123',21.00,1.00,0.00,21.00),(135,138,'TAJ123',21.25,1.00,0.00,25.00),(136,138,'TAJ123',21.25,1.00,0.00,25.00),(137,139,'LECH123',30.55,1.00,0.00,30.55),(138,140,'LECH123',30.55,1.00,0.00,30.55),(139,141,'LECH123',30.55,40.00,0.00,1222.00),(140,142,'LECH123',30.55,1.00,0.00,30.55),(141,143,'LECH123',30.55,8.00,0.00,244.40),(142,144,'LECH123',30.55,8.00,0.00,244.40);
...
CREATE TABLE `security_answers` (
  `COD_RESPONSE` bigint NOT NULL AUTO_INCREMENT,
  `RESPONSE` text COLLATE utf8_unicode_ci,
  `COD_QUESTION` bigint DEFAULT NULL,
  `COD_USER` bigint DEFAULT NULL,
  PRIMARY KEY (`COD_RESPONSE`),
  KEY `FK_ANSWERS_QUESTIONS` (`COD_QUESTION`),
  KEY `FK_ANSWERS_USER` (`COD_USER`),
  CONSTRAINT `FK_ANSWERS_QUESTIONS` FOREIGN KEY (`COD_QUESTION`) REFERENCES `security_questions` (`COD_QUESTION`) ON DELETE CASCADE,
  CONSTRAINT `FK_ANSWERS_USER` FOREIGN KEY (`COD_USER`) REFERENCES `user` (`COD_USER`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `security_answers` VALUES (1,'Prueba1',1,3),(2,'Prueba2',2,3),(3,'Prueba3',3,3),(4,'Prueba1',6,11),(5,'Prueba2',2,11),(6,'Prueba3',4,11);
...
CREATE TABLE `security_questions` (
  `COD_QUESTION` bigint NOT NULL AUTO_INCREMENT,
...
INSERT INTO `security_questions` VALUES (1,'¿Cuál era el apellido de tu profesora de tercero de primaria?'),(2,'¿A qué universidad intentaste entrar pero finalmente no fuiste?'),(3,'¿Con quién te diste tu primer beso?'),(4,'¿A qué secundaria fuiste?'),(5,'¿Cuál era el nombre de tu primer mascota?'),(6,'¿Cuál es el nombre de tu primo favorito?');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `taxes` (
  `COD_TAX` bigint NOT NULL AUTO_INCREMENT,
  `TAX` decimal(10,2) NOT NULL,
  `COD_STATUS` bigint DEFAULT NULL,
  PRIMARY KEY (`COD_TAX`),
  KEY `FK_TAXES_STATUS` (`COD_STATUS`),
...
INSERT INTO `taxes` VALUES (1,0.18,1),(2,0.20,2),(3,0.15,1);
...
INSERT INTO `typ_product_entries` VALUES (1,'Compra','Compra a proveedores'),(2,'Devoluciones','Devoluciones entrantes'),(5,'Erfdd','DWD'),(6,'Sad','dsadasd');
...
INSERT INTO `typ_product_output` VALUES (1,'Venta','Venta a proveedores'),(2,'Devolución','Devoluciones a proveedores'),(3,'Mermas','Mermas de productos'),(7,'Sddsd','sdd');
...
-- Dump completed on 2022-08-22 21:29:46
