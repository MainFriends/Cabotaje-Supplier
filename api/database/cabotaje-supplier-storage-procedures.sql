...
CREATE PROCEDURE SP_SEL_PRODUCT_OUTPUT(
	...
	IF  _COD_OUTPUT = 0 THEN
			SELECT COD_OUTPUT, PRODUCT_OUTPUT.COD_PRODUCT, NAM_PRODUCT, DES_OUTPUT, PRODUCT_OUTPUT.COD_TYPE, NAM_TYPE, CANT_PRODUCT, NUM_LOT,
            CONCAT(FIRST_NAME, ' ', LAST_NAME) USER_NAME, DAT_OUTPUT
            FROM PRODUCT_OUTPUT, INVENTORY, USER, TYP_PRODUCT_OUTPUT
