...
CREATE PROCEDURE SP_SEL_PRODUCT_ENTRIES(
	...
	IF  _COD_ENTRIES = 0 THEN
			SELECT COD_ENTRIES, PRODUCT_ENTRIES.COD_PRODUCT, NAM_PRODUCT, DES_RETURN, PRODUCT_ENTRIES.COD_TYPE, NAM_TYPE, CANT_PRODUCT, NUM_LOT, NAM_SUPPLIER,
