...
CREATE PROCEDURE SP_LOGIN(IN
    ...
    IF @USER >= 1 THEN
		SELECT USER.COD_USER, COD_ROLE, FIRST_NAME, LAST_NAME, USER_PASSWORD, DAT_EXP, COD_STATUS FROM USER, LOGIN
...
-- INSERT EN LA BD--
    ...
    ELSE  
		IF _COD_ORDER = 0 THEN
			...
			VALUES (_COD_PRODUCT,_DAT_PURCHASE,_DAT_EXP,_CANT_PRODUCTS,_NUM_LOT, NULL, _COD_STATUS);
		ELSE
			INSERT INTO INVENTORY_DETAIL (COD_PRODUCT,DAT_PURCHASE, DAT_EXP, CANT_PRODUCTS, NUM_LOT, COD_ORDER, COD_STATUS)
...
CREATE PROCEDURE SP_UPD_PASSWORD(IN _COD_USER BIGINT,
	...
	UPDATE LOGIN
    SET USER_PASSWORD = _USER_PASSWORD,
    DAT_EXP = DATE_ADD(NOW(), INTERVAL 30 DAY)
    WHERE COD_USER = _COD_USER;
END;
//
