...
CREATE PROCEDURE SP_ROLES(
	...
	SELECT PERMISSIONS.COD_ROLE, NAM_ROLE, DES_ROLE, NAM_MODULE, INS, DEL, UPD, QUE FROM 
	PERMISSIONS, ROLE, MODULES
	WHERE PERMISSIONS.COD_ROLE = ROLE.COD_ROLE
	AND PERMISSIONS.COD_MODULE = MODULES.COD_MODULE;
END;
//
