...
-- INSERT
  ...
  -- INSERTAR DATOS A LOGIN
	...
	IF @USERCOUNT != 0 THEN
	   ...
	   INSERT INTO MS_BITACORA(COD_USER, ACTION, DESCRIPTION, DATE)
	   VALUES(_COD_USER, 'Agregar', CONCAT('Agregó a un nuevo usuario ', @USER_ADD), Now());
	END IF;
...
START TRANSACTION;
	...
	INSERT INTO MS_BITACORA(COD_USER, ACTION, DESCRIPTION, DATE)
	VALUES(_USER_ACTIVITY, 'Editar', CONCAT('Editó campos del usuario ', @USER_EDITED), Now());
...
CREATE PROCEDURE SP_DEL_USER(
	...
	INSERT INTO MS_BITACORA(COD_USER, ACTION, DESCRIPTION, DATE)
	VALUES(_USER_ACTIVITY, 'Eliminar', CONCAT('Eliminó al usuario ', @USER_DELETED), Now());
END;
//
...
BEGIN
	SELECT CONCAT(FIRST_NAME, ' ', LAST_NAME) USUARIO, ACTION, DESCRIPTION, DATE
