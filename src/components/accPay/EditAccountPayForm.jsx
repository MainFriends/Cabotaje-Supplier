        ...
        <form id='AddAccountPayForm' onSubmit={handleSubmitAccountPayForm} action='#'>
            <div className="row mb-4">
                ...
                <div className="col-md-3 mt-3">
                    ...
                    <input min={moment().format('YYYY-MM-DD')} onChange={handleInputChange} value={moment(formEditAccountPay.DATE_LIMIT).format('YYYY-MM-DD')} className='form-control' name='DATE_LIMIT' type="date" required/>
                </div>
            </div>
