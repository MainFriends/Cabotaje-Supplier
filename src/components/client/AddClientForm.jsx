        ...
        <form id='addFormClient' onSubmit={handleSubmitClient} action='#'>
            <div className="row mb-4">
                ...
                <div className="col-md-4">
                    ...
                    <input onChange={handleInputChange} className='form-control' name='IDENTITY'  minlenght={13} maxLength={13}  type="text" pattern="[0-9]{13}"  title="IDENTIDAD debe contener 13 caracteres " placeholder="####-####-######"  required/>
                </div>
                ...
                <div className="col-md-3 mt-2">
                    ...
                    <input onChange={handleInputChange} className='form-control' name='NUM_PHONE_TWO' type="tel" pattern="[0-9]{1,8}"  placeholder="####-####" min={0} maxLength={8} title="OPCIONAL" required/>
                </div>
                ...
                <div className="col-md-6">
                    ...
                    <input onChange={handleInputChange} className='form-control' name='RTN' type="text" minLength={14}  maxLength={14}  pattern="[0-9]{14}"  placeholder="####-####-######" title="RTN debe contener 14 caracteres" required/>
                </div>
            </div>
