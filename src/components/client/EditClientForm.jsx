        ...
        <form id='editFormClient' onSubmit={handleSubmitClient} action='#'>
            <div className="row mb-4">
                ...
                <div className="col-md-4">
                    ...
                    <input onChange={handleInputChange} value={formEditClient.MIDDLE_NAME} className='form-control' name='MIDDLE_NAME' type="text"minLength={1} maxLength={15}  pattern="^[a-zA-ZñÑáéíóú ]+$"  title="Segundo nombre no debe contener carácteres especiales y/o númericos." onInput={toUpperCase} required/>
                </div>
                <div className="col-md-4">
                    <label className='form-label' htmlFor="LAST_NAME">Primer apellido<span className="text-danger"> *</span></label>
                    <input onChange={handleInputChange} value={formEditClient.LAST_NAME} className='form-control' name='LAST_NAME' type="text" minLength={1} maxLength={15}   pattern="^[a-zA-ZñÑáéíóú ]+$" title="Primer apellido no debe contener carácteres especiales y/o númericos." onInput={toUpperCase}required/>
                </div>
                <div className="col-md-4 mt-2">
                    <label className='form-label' htmlFor="SECOND_LAST_NAME">Segundo apellido</label>
                    <input onChange={handleInputChange} value={formEditClient.SECOND_LAST_NAME} className='form-control' name='SECOND_LAST_NAME' type="text" minLength={1} maxLength={15}   pattern="^[a-zA-ZñÑáéíóú ]+$" title="Segundo apellido no debe contener carácteres especiales y/o númericos." onInput={toUpperCase}/>
