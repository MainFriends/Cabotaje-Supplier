        ...
        <form id='editFormClient' onSubmit={handleSubmitClient} action='#'>
            <div className="row mb-4">
                ...
                <div className="col-md-4">
                    ...
                    <input onChange={handleInputChange} value={`0${formEditClient.IDENTITY}`} className='form-control' name='IDENTITY'  minlenght={13} maxLength={13}  type="text" pattern="[0-9]{13}"  title="Identidad debe contener 13 carácteres númericos, sin guines ni espacios." required/>
                </div>
                ...
                <div className="col-md-3 mt-2">
                    ...
                    <input onChange={handleInputChange} value={formEditClient.NUM_PHONE_TWO} className='form-control' name='NUM_PHONE_TWO' type="tel" pattern="[0-9]{1,8}" min={0}  maxLength={8} title="El número telefónico debe contener 8 caracteres númericos, sin guiones ni espacios." required/>
                </div>
                ...
                <div className="col-md-6">
                    ...
                    <input onChange={handleInputChange} value={`0${formEditClient.RTN}`} className='form-control' name='RTN' type="text" minLength={14}  maxLength={14}  pattern="[0-9]{14}" title="RTN debe contener 14 cáracteres númericos, sin guiones ni espacios." required/>
                </div>
            </div>
