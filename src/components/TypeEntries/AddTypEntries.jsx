        ...
        <form id='addTypEntries' onSubmit={handleSubmitTypEntries} action='#'>
            <div className="row mb-4">
                <div className="col-md-4">
                    ...
                    <input onChange={handleInputChange} className='form-control' name='NAM_TYPE' type="text" pattern="^[a-zA-ZñÑáéíóú ]+$" title="El tipo de entrada no debe contener números." onInput={toUpperCase}required/>
                </div>
                <div className="col-md-4">
