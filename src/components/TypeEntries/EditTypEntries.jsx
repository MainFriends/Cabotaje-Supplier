        ...
        <form id='editFormTypEntries' onSubmit={handleSubmitTypEntrie} action='#'>
            <div className="row mb-4">
                <div className="col-md-4">
                    ...
                    <input onChange={handleInputChange} value={formEditTypEntrie.NAM_TYPE ? formEditTypEntrie.NAM_TYPE : '' } pattern="^[a-zA-ZñÑáéíóú ]+$" title="El tipo de entrada no debe contener números." className='form-control' name='NAM_TYPE' type="text"minLength={1} maxLength={15} onInput={toUpperCase} required/>
                </div>
                <div className="col-md-4">
